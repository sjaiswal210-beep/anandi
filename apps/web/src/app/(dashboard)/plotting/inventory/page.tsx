        ...
        <div className="bg-card border-2 border-blue-200 dark:border-blue-800 rounded-xl p-5">
          ...
          {selectedPlot.status === 'AVAILABLE' && (
            <div className="mt-4 flex gap-3 flex-wrap">
              ...
              <a
                href={`https://wa.me/918007107799?text=${encodeURIComponent(`Hi, I am interested in plot ${selectedPlot.plotNumber} (${Number(selectedPlot.area).toLocaleString()} sqft). Please share details.`)}`}
